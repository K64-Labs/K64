...
OBJ="${WORK_DIR}/k64xfs.o"
MODULE_IN="${WORK_DIR}/k64xfs.module"
MODULE_OUT="${PLATFORM_DIR}/k64xfs.mod"
...
if ! grep -q '^k64xfs:' "${PLATFORM_DIR}/moddep.lst"; then
